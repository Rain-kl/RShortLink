...
package com.rlink.project.controller;

import com.alibaba.csp.sentinel.annotation.SentinelResource;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.rlink.project.common.convention.result.Result;
import com.rlink.project.common.convention.result.Results;
...
import com.rlink.project.handler.CustomBlockHandler;
...
public class ShortLinkController {
    ...
    @SentinelResource(value = "create_short-link", blockHandler = "createShortLinkBlockHandlerMethod", blockHandlerClass = CustomBlockHandler.class)
    ...
    public Result<IPage<ShortLinkPageRespDTO>> adminPageShortLink(AdminShortLinkPageReqDTO requestParam) {
        return Results.success(shortLinkService.adminPageShortLink(requestParam));
    }

    @GetMapping("/api/short-link/v1/admin/overview")
    public Result<AdminShortLinkOverviewRespDTO> adminShortLinkOverview() {
        return Results.success(shortLinkService.adminShortLinkOverview());
    }
}
