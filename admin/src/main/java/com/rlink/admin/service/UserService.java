...
public interface UserService extends IService<UserDO> {
     ...
     * 管理员创建用户
     */
    void adminCreate(UserRegisterReqDTO requestParam);
     ...
     * 管理员分页查询用户
     */
    Page<UserRespDTO> pageUsers(UserPageReqDTO requestParam);

    /**
     * 管理员更新用户信息
     */
    void adminUpdate(UserUpdateReqDTO requestParam);

    /**
     * 管理员更新用户状态
     */
    void updateUserStatus(UserStatusUpdateReqDTO requestParam);
