...
const formData = reactive({
  ...
  gid: editData.gid ?? props.defaultGid,
  originGid: editData.gid ?? props.defaultGid,
...
const initFormData = () => {
  ...
  formData.gid = props.defaultGid ?? null
  formData.originGid = props.defaultGid ?? null
...
watch(
  ...
  (nV) => {
    ...
    formData.gid = nV.gid ?? props.defaultGid
    formData.originGid = nV.gid ?? props.defaultGid
